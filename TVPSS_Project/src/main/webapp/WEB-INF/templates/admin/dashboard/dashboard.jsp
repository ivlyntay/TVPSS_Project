...
<body class="bg-gray-50">
    <div class="container">
        <div th:replace="~{admin_sidebar :: admin_sidebar('dashboard')}"></div>
        ...
        <div class="main-content p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-gray-500 text-sm">Total Schools</h3>
                            <p class="text-2xl font-semibold text-gray-700" th:text="${totalSchools}">0</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-gray-500 text-sm">Total Crew Members</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <!-- Content per School -->
                <div class="bg-white rounded-xl shadow-lg p-6">
                    <h3 class="text-lg font-semibold mb-4">Content per School</h3>
                    <table class="min-w-full">
                        <thead>
                            <tr>
                                <th class="text-left py-2">School</th>
                                <th class="text-right py-2">Content Count</th>
                                <th class="text-right py-2">Percentage</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr th:each="school : ${contentPerSchool}">
                                <td class="py-2" th:text="${school.key}">School</td>
                                <td class="text-right py-2" th:text="${school.value}">0</td>
                                <td class="text-right py-2" 
                                    th:text="${#numbers.formatDecimal(school.value * 100.0 / totalContent, 1, 1) + '%'}">
                                    0%
                                </td>
                            </tr>
                        </tbody>
